classdef PDE < SOFEClass
  ...
  methods % constructor & more
    ...
    function setState(obj, varargin)
      ...
      for j = 1:obj.nEq
        nBlock = obj.fesTrial{j}.mesh.nBlock;
    ...
    function assemble(obj)
      ...
      if isempty(obj.shift)
        ...
        for j = 1:obj.nEq
          ...
          obj.fDoFsTest(obj.I{j}(1):obj.I{j}(2),1) = obj.fesTest{j}.freeDoFs;
          obj.fDoFsTrial(obj.J{j}(1):obj.J{j}(2),1) = obj.fesTrial{j}.freeDoFs;
        end
      end
    end
    function solve(obj)
